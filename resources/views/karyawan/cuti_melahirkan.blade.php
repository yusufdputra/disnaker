  ...
  <div class="custom-modal-text">
    ...
    <div class="p-20">
      ...
      <form class="form-horizontal m-t-20" action="{{'tambah-cuti'}}" method="POST">
        ...
        <div class="form-group">
          <div class="col-xs-12">
            <textarea  required name="alasan" class="form-control" maxlength="225" rows="2" placeholder="Alasan Cuti"></textarea>
          </div>
        </div>

        <div class="form-group">
          <div class="col-xs-12">
            <textarea  required name="tujuan" class="form-control" maxlength="225" rows="2" placeholder="Tujuan Cuti"></textarea>
          </div>
        </div>
          ...
          <div class="col-xs-12">
            <div class="input-group">
              <div class="input-daterange input-group" id="datepicker">
                ...
                <input type="text" placeholder="Tanggal Awal (dd-M-yyyy)" class="left-text form-control" name="tanggal_cuti_start" autocomplete="off" />
                <!-- <input type="text" placeholder="Akhir (mm/dd/yyyy)" class="form-control" name="tanggal_cuti_end" /> -->
